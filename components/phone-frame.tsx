...
export function PhoneFrame({
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      {/* Volume up */}
      <div className="absolute -left-[5px] top-[19%] w-[5px] h-7 rounded-l-sm bg-border" />
      {/* Volume down */}
      <div className="absolute -left-[5px] top-[27%] w-[5px] h-7 rounded-l-sm bg-border" />
      {/* Power button */}
      <div className="absolute -right-[5px] top-[23%] w-[5px] h-11 rounded-r-sm bg-border" />

      {/* Chassis */}
      <div className="relative rounded-[2.5rem] border-[6px] border-border bg-card overflow-hidden shadow-2xl">

        {/* Top bezel with pill camera */}
        ...
        <div className="h-5 bg-card flex items-end justify-center pb-1.5">
